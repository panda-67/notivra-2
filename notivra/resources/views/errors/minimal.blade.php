    ...
    <body class="antialiased bg-white text-black">
        <div class="relative flex items-top justify-center min-h-screen bg-white text-black sm:items-center sm:pt-0" role="main">
            <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="flex items-center justify-center pt-8 sm:pt-0 w-full">
                    <a href="{{ route('dashboard') }}"
                        class="flex items-center space-x-2 px-6 py-3 bg-blue-50 text-blue-700 rounded-lg hover:bg-blue-100 hover:text-blue-800 transition-colors duration-200">
