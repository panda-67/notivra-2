    ...
    <AppLayout title="Wawasan Riset">
            ...
            <div v-else>
                <div class="mx-auto max-w-7xl px-4 py-2 sm:px-6 lg:px-8">
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        ...
                        <div v-else>
                            <h1 class="text-2xl font-bold text-slate-900 font-display">Research Working Room</h1>
                            <p class="text-sm text-slate-500 mt-1">Manage progress of your colaboration dan publication
                                draft.</p>
                        </div>
                        ...
                        <Link :href="route('hire.apply')"
                            ...
                            <span v-if="locale === 'id'"> + Ajukan Kolaborasi Baru </span>
                            <span v-else> + Apply New Colaboration</span>
                        </Link>
                    </div>
                </div>
            </div>
        ...
        <div v-else class="py-24 text-center">
            <div class="max-w-md prose mx-auto px-6">
                ...
                <template v-else>
                    <h3 class="text-slate-900 font-bold text-xl">Ready to collaboration for Nusantara?</h3>
                    <p class="text-slate-500 text-sm mt-2">
                        Sign in to your account for accessing research collaboraion and publication insight features.
                    </p>
